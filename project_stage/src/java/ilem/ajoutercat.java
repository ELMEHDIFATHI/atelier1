 ...
 * @author FATHI
 */
@WebServlet(name = "ajoutercat", urlPatterns = {"/ajoutercat"})
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            try{
                ...
                String marque=request.getParameter("marque");
                        PreparedStatement pr=con.prepareStatement("insert into categorie(marque) values(?)");
                ...
                System.out.println("ajoutercat :"+E.getMessage());
            }
